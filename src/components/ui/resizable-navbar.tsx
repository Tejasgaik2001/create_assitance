    ...
    >
      {items.map((item, idx) => (
        ...
        >
          ...
          <span className="absolute bottom-0 left-0 h-[2px] w-full origin-left scale-x-0 bg-violet-600 transition-transform duration-300 ease-out group-hover:scale-x-100 dark:bg-violet-400" />
        </a>
      ))}
    </motion.div>
  );
